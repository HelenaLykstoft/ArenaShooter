...
namespace RehtseStudio.SimpleWaveSystem.Managers
{
    ...
    public class WaveSystemManager : MonoBehaviour
    {
        ...
        {
            return _wavesReference[waveId].GetWaveLenght();
        }

        public int ReturnObjectTypeId(int waveId, int enemynumber)
        {
            
            return _wavesReference[waveId].ReturnObjectType(enemynumber);
        }
